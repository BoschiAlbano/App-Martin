...
namespace Servicios.Persona
{
    public class Cliente : Persona
    {
        ...
        public override void Modificar(PersonaDto entidad)
        {
            ...
            var Busqueda = _unidadDeTrabajo.ClienteRepositorio.Obtener(entidad.Id);

            Busqueda.Nombre = entidadModificar.Apellido;
            Busqueda.Direccion = entidadModificar.Direccion;
            Busqueda.Dni = entidadModificar.Dni;
            Busqueda.Mail = entidadModificar.Mail;
            Busqueda.LocalidadId = entidadModificar.LocalidadId;
            Busqueda.Nombre = entidadModificar.Nombre;
            Busqueda.Telefono = entidadModificar.Telefono;
            Busqueda.ActivarCtaCte = entidadModificar.ActivarCtaCte;
            Busqueda.MontoMaximoCtaCte = entidadModificar.MontoMaximoCtaCte;
            Busqueda.TieneLimiteCompra = entidadModificar.TieneLimiteCompra;


            _unidadDeTrabajo.ClienteRepositorio.Modificar(Busqueda);
        ...
        public override IEnumerable<PersonaDto> Obtener(string cadenaBuscar)
        {
            ...
            return _unidadDeTrabajo.ClienteRepositorio.Obtener(filtro, "Localidad, " +
        ...
        {
            var entidad = _unidadDeTrabajo.ClienteRepositorio.Obtener(id, "Localidad, " +
                                                                          "Localidad.Departamento, Localidad.Departamento.Provincia");
