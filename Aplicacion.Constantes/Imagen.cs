...
namespace Aplicacion.Constantes
{
    ...
    {
        public static Image ImagenEmpleadoPorDefecto = Properties.RecursoImagenes.Nuevo_Usuario;

        public static Image ImagenProductoPorDefecto = Properties.RecursoImagenes.Nuevo_Producto;
