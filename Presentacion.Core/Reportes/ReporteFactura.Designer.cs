...
namespace Presentacion.Core.Reportes
{
    partial class ReporteFactura
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.FacturaDtoBindingSource.DataSource = typeof(IServicios.Comprobante.DTOs.FacturaDto);
            // 
            // menuStrip1
            // 
            ...
            reportDataSource1.Value = this.FacturaDtoBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Presentacion.Core.Reportes.ReporteFactura.rdlc";
